...
# Dit script voert een evaluatie uit op een netwerk met data uit de dataset
# Dit script dient aangeroepen te worden uit een terminal
# Via Pycharm kan dit makkelijk gedaan worden
# De eerste sectie van dit scripe geeft de mogelijkheden en variabelen aan.
...
if __name__ == '__main__':
    ...
    if args.jacquard_output:
        ...
        with open(jo_fn, 'w') as f:
            pass
            # maken van predictie op dataset
    with torch.no_grad():
        for idx, (x, y, didx, rot, zoom) in enumerate(test_data):
            ...
            if args.iou_eval:
                ...
                if s:
                    ...
                    results['failed'] += 1
            # Dit wordt gebruikt bij de Jacquard dataset
            if args.jacquard_output:
